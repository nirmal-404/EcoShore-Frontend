    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-background">
        <div className="absolute inset-0 z-0">
          ...
          <div
            className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-secondary/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="container relative z-10 mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-10 duration-1000">
            ...
            <Link
              to="/events"
              className="px-8 py-4 bg-white border border-border text-foreground rounded-full font-semibold hover:bg-secondary/5 transition-all"
            >
              Explore Events
            </Link>
          </div>
