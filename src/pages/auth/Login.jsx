...
export default function Login({ handleRegisterDialogOpen }) {
  ...
  return (
    <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden">
      ...
      <div className="max-h-[min(90vh,600px)] overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700">
