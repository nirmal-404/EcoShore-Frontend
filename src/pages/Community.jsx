...
import { Loader2, Users, MessageSquare, BookOpen, ArrowRight, Waves } from 'lucide-react';
import { cn } from '@/lib/utils';

const TYPE_BADGE = {
    GLOBAL_VOLUNTEER: { label: 'Volunteer', color: 'bg-emerald-500/15 text-emerald-500 border border-emerald-500/20' },
    ORGANIZER_PRIVATE: { label: 'Organizer', color: 'bg-purple-500/15 text-purple-400 border border-purple-500/20' },
    EVENT_GROUP: { label: 'Event', color: 'bg-blue-500/15 text-blue-400 border border-blue-500/20' },
};
    ...
    if (!user) {
        return (
            <div className="text-center py-14 bg-secondary/10 rounded-3xl border border-dashed border-border/60">
                ...
                <h3 className="text-lg font-bold text-foreground">Sign in to access group chats</h3>
        ...
        return (
            <div className="text-center py-16 bg-secondary/5 rounded-3xl border border-dashed border-border/60">
                ...
                <p className="text-muted-foreground mt-2 font-medium max-w-sm mx-auto text-sm leading-relaxed">
                    Group chats are automatically created for events you join. Check back after registering for a cleanup!
                </p>
            </div>
        );
    }
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 className="font-semibold text-foreground text-[15px] truncate">{group.name}</h3>
                            <div className="flex items-center gap-2 mt-1">
                                <span className={cn('text-[10px] font-bold uppercase tracking-wide px-2 py-0.5 rounded-full', badge.color)}>
                                    {badge.label}
                                </span>
            ...
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-4 mb-8">
                    ...
                    <p className="text-muted-foreground text-lg max-w-xl mx-auto font-medium leading-relaxed">
                        Connect, share updates, and inspire others through environmental action.
                    </p>
                </div>
                        ...
                        <div className="space-y-6 max-w-2xl mx-auto">
                            {isLoading ? (
                                ...
                                <div className="text-center py-20 bg-muted/20 rounded-3xl border border-dashed border-border/60">
                                    ...
                                    <h3 className="text-xl font-bold text-foreground">It's quiet here...</h3>
                                    <p className="text-muted-foreground mt-2 font-medium">
